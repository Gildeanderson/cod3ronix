        ...
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-text-s hover:text-white hover:bg-white/10 transition-all"><Twitter size={18} /></a>
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-text-s hover:text-white hover:bg-white/10 transition-all"><Linkedin size={18} /></a>
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-text-s hover:text-white hover:bg-white/10 transition-all"><Instagram size={18} /></a>
            </div>
          </div>
          <div>
